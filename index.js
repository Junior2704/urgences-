...
// Autoriser ton site GitHub Pages à accéder à ce serveur
app.use(cors({
  origin: "https://junior2704.github.io"
}));

app.get("/", (req, res) => res.send("✅ Proxy Render en ligne et opérationnel"));

// Route d’upload du PDF
app.post("/upload", upload.single("file"), async (req, res) => {
  try {
    ...
    // Envoi vers File.io (valide 7 jours)
